...
export const ROUTES=['dashboard','daily-collection','students','fee-entry','ledger','fee-slip','student-counter','d6','reports','settings','users','student-portal'];
export const ROUTE_ALIASES=Object.freeze({
  ...
  users:'users','user management':'users','student portal':'student-portal','student-portal':'student-portal',
